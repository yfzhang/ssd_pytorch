...
class MultiBoxLayer(nn.Module):
    ...
    def __init__(self):
        ...
        for i in range(len(self.in_planes)):
            ...
            self.conf_layers.append(nn.Conv2d(self.in_planes[i], self.num_anchors[i] * self.num_classes, kernel_size=3, padding=1)) # TODO: changed from 21 to num_classes
    ...
    def forward(self, xs):
        ...
        for i, x in enumerate(xs):
            ...
            y_conf = y_conf.view(N, -1, self.num_classes) # TODO: changed from 21 to num_classes
